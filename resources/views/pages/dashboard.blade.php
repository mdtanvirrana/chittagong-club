        ...
        <section class="px-6 py-6 flex flex-col gap-6">
            <div class="flex items-center gap-5">
                <div class="relative">
                    <div class="size-20 rounded-full gold-border p-1 bg-background-dark">
                        <div class="size-full rounded-full bg-center bg-cover"
                             style="background-image: url('{{ asset('images/' . session('member.id') . '.jpg') }}')">
                        </div>
                    </div>
                ...
                <div class="flex flex-col">
                    ...
                    <h2 class="text-xl font-bold tracking-tight">{{ session()->get('member.name') }}</h2>
                    <p class="text-primary text-sm font-semibold mt-1">{{ session()->get('member.id') }}</p>
                </div>
            </div>
